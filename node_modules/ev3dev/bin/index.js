...
var MotorBase = (function (_super) {
    ...
    function MotorBase(port, type) {
        ...
        try {
            ...
            for (var i in availableDevices) {
                ...
                var portName = fs.readFileSync(path.join(rootPath, this.motorBaseProperties.portName)).toString().trim();
                var motorType = fs.readFileSync(path.join(rootPath, this.motorBaseProperties.type)).toString().trim();
    ...
    Object.defineProperty(MotorBase.prototype, "motorBaseProperties", {
        get: function () {
            return {
                portName: 'port_name',
                type: 'type'
...
var DCMotor = (function (_super) {
    ...
    Object.defineProperty(DCMotor.prototype, "typeName", {
        get: function () {
    ...
    Object.defineProperty(DCMotor.prototype, "rampDownMs", {
        get: function () {
    ...
    Object.defineProperty(DCMotor.prototype, "rampUpMs", {
        get: function () {
...
var ServoMotor = (function (_super) {
    ...
    Object.defineProperty(ServoMotor.prototype, "typeName", {
        get: function () {
            return this.getString("name");
        },
        enumerable: true,
    ...
    Object.defineProperty(ServoMotor.prototype, "maxPulseMs", {
        get: function () {
    ...
    Object.defineProperty(ServoMotor.prototype, "midPulseMs", {
        get: function () {
    ...
    Object.defineProperty(ServoMotor.prototype, "minPulseMs", {
        get: function () {
    ...
    Object.defineProperty(ServoMotor.prototype, "position", {
        get: function () {
    ...
    Object.defineProperty(ServoMotor.prototype, "rate", {
        get: function () {
    ...
    function Sensor(port, types, i2cAddress) {
        ...
        try {
            ...
            for (var i in availableDevices) {
                ...
                var satisfiesCondition = ((port == ports.INPUT_AUTO) || (port == undefined) || (portName === port)) && ((types == undefined || types == [])) && ((i2cAddress == undefined) || (i2cAddress == i2cDeviceAddress));
                if (satisfiesCondition) {
